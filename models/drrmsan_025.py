...
def DRRMSAN_multiscale_attention_bayes_025(height, width, n_channels, alpha_1, alpha_2, alpha_3, alpha_4):
    '''
    ...
    up6 = concatenate([up6, mresblock4, left_block_3])
    ...
    up7 = concatenate([up7, mresblock3, left_block_2])
    ...
    up8 = concatenate([up8, mresblock2, left_block_1])#,
