...
def proposed_attention_block_2d(ms_conv, res_block, filters):
    ...
    theta_x = Conv2D(filters, [2,  2], strides=[1, 1], padding='same', kernel_initializer = 'he_normal', kernel_regularizer=l2(1e-4))(ms_conv)
    ...
    add_1x1_upper = Activation('relu')(Conv2D(filters, [2,  2], strides=[1, 1], padding='same', kernel_initializer = 'he_normal', kernel_regularizer=l2(1e-4))(add_3x3_5x5_7x7))
    mult_1x1_lower = Activation('relu')(Conv2D(filters, [2,  2], strides=[1, 1], padding='same', kernel_initializer = 'he_normal', kernel_regularizer=l2(1e-4))(mul_3x3_5x5_7x7))
    ...
    theta_x_rb = Conv2D(filters, [2,  2], strides=[1, 1], padding='same', kernel_initializer = 'he_normal', kernel_regularizer=l2(1e-4))(res_block)
    ...
    add_1x1_upper_rb = Activation('relu')(Conv2D(filters, [2,  2], strides=[1, 1], padding='same', kernel_initializer = 'he_normal', kernel_regularizer=l2(1e-4))(add_3x3_5x5_7x7_rb))
    mult_1x1_lower_rb = Activation('relu')(Conv2D(filters, [2, 2], strides=[1, 1], padding='same', kernel_initializer = 'he_normal', kernel_regularizer=l2(1e-4))(mul_3x3_5x5_7x7_rb))
