...
def DRRMSAN_multiscale_attention_bayes_021(height, width, n_channels, alpha_1, alpha_2, alpha_3, alpha_4):
    '''
    ...
    total_1_2I = 51
    per_mx_pool_1_2I = int(0.15 * total_1_2I)
    per_avg_pool_1_2I = int(0.15 * total_1_2I)
    per_min_pool_1_2I = int(0.30 * total_1_2I)
    ...
    total_1_4I = 105
    per_mx_pool_1_4I = int(0.15 * total_1_4I)
    per_avg_pool_1_4I = int(0.15 * total_1_4I)
    per_min_pool_1_4I = int(0.30 * total_1_4I)
    ...
    total_1_8I = 212
    per_mx_pool_1_8I = int(0.15 * total_1_8I)
    per_avg_pool_1_8I = int(0.15 * total_1_8I)
    per_min_pool_1_8I = int(0.30 * total_1_8I)
