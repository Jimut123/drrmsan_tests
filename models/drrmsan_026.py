...
def DRRMSAN_multiscale_attention_bayes_026(height, width, n_channels, alpha_1, alpha_2, alpha_3, alpha_4):
    '''
    ...
    conv_6_up = Conv2D(212, (3, 3), padding='same', activation='relu', name='conv_6_up')(concatenate([mresblock6, up6]))
    ...
    conv_7_up = Conv2D(105, (3, 3), padding='same', activation='relu', name='conv_7_up')(concatenate([mresblock7, up7]))
    ...
    conv_8_up = Conv2D(51, (3, 3), padding='same', activation='relu', name='conv_8_up')(concatenate([mresblock8, up8]))
    ...
    conv_9_up = Conv2D(32, (3, 3), padding='same', activation='relu', name='conv_8_up')(concatenate([mresblock9, up9]))
