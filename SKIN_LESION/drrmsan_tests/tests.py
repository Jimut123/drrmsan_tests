...
import sys
sys.path.insert(0, '../../')
from models import DRRMSAN_multiscale_attention_bayes_016
...
def evaluateModel(model, X_test, Y_test, batchSize):
    ...
    with open("Output_20_wod_relur.txt", "a") as text_file:
...
for i in range(20):
    ...
    alpha_3 = 0.25
    alpha_4 = 0.25
    model = DRRMSAN_multiscale_attention_bayes_016(height=192, width=256, n_channels=3, alpha_1 = alpha_1, alpha_2 = alpha_2, alpha_3 = alpha_3, alpha_4 = alpha_4)
