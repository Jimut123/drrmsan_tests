...
import sys
sys.path.insert(0, '../../')
from models import DRRMSAN_multiscale_attention_bayes_018
...
<<<<<<< HEAD
    with open("Output_150_superconc.txt", "a") as text_file:
=======
    with open("Output_20_sc_nominpooling.txt", "a") as text_file:
>>>>>>> fd6c4aebcd383b0ca55817e06c7eb7b0d26de883
...
for i in range(20):
    ...
    alpha_3 = 0.25
    alpha_4 = 0.25
    model = DRRMSAN_multiscale_attention_bayes_018(height=192, width=256, n_channels=3, alpha_1 = alpha_1, alpha_2 = alpha_2, alpha_3 = alpha_3, alpha_4 = alpha_4)
