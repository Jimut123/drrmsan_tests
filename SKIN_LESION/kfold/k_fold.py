...
import sys
sys.path.insert(0, '../../')
from models import DRRMSAN_multiscale_attention_bayes_017
...
for train_index, test_index in kf.split(X):
    ...
    def trainStep(model, X_train, Y_train, X_test, Y_test, epochs, batchSize):
        ...
        # save to json:
        hist_json_file = 'history_drrmsan_skinLesion_fold_{}.json'.format(fold_no)
        ...
        # or save to csv:
        hist_csv_file = 'history_drrmsan_skinLesion_fold_{}.csv'.format(fold_no)
    ...
    model = DRRMSAN_multiscale_attention_bayes_017(height=192, width=256, n_channels=3, alpha_1 = alpha_1, alpha_2 = alpha_2, alpha_3 = alpha_3, alpha_4 = alpha_4)
