...
model.load_weights('modelW_drrmsan_nerve.h5')

model.summary()

# img = cv2.imread('img_lungs.png',cv2.IMREAD_COLOR)
img = cv2.imread('1_3.tif',cv2.IMREAD_COLOR)
# 1
plt.imsave('1_1.png', img[:,:,::-1])
...
lclns = ['conv2d_63','conv2d_90','conv2d_94','conv2d_5','conv2d_8','conv2d_115','conv2d_113','conv2d_125','conv2d_142']
last_conv_layer_name = "activation_116"
