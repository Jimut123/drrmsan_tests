...
model.load_weights('modelW_drrmsan_chest.h5')

model.summary()

# img = cv2.imread('img_lungs.png',cv2.IMREAD_COLOR)
img = cv2.imread('MCUCXR_0005_0.png.png',cv2.IMREAD_COLOR)
# 1
...
lclns = ['conv2d_34','conv2d_60','conv2d_67','conv2d_89','conv2d_116','conv2d_113']
last_conv_layer_name = "activation_115"
